    ...
    <form name="dataForm" method="post" action="cancel.php" >
      <table border="3" align="center" class = "table table-striped" bordercolor="rhba(255,255,255,0)">
		...
		for($i=0;$i<$num;$i++)
		{
			...
			$echostring .= $row{"ordercode"}."'</td><td align='center'>";
			echo $echostring;
			$temp = $row{"orderlist"};
			...
			foreach($picture as $value)
			{
				...
				echo $row2{"foodname"};
				echo "<br><img src=\""."\\project\\restaurant\\menu\\".$value.".jpg\" width = '100'><br>";
			}
			echo "</td></tr>";
			$result++;
			$row = mysqli_fetch_assoc($result);
        ...
        <tr bgcolor="#99FF99"> 
          <td colspan="2" align="CENTER">
			<div class="form-group">
				...
				if($num != 0){
				?>
					<button type="submit" class="btn btn-primary">取消訂位</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
